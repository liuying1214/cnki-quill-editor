...
class Quill {
  ...
  constructor(container, options = {}) {
    ...
    this.emitter.on(Emitter.events.SCROLL_UPDATE, (source, mutations) => {
      ...
      const [newRange] = this.selection.getRange('quill-SCROLL_UPDATE');
      const selectionInfo =
  ...
  getSelection (focus = false) {
    ...
    return this.selection.getRange('quill-getSelection')[0];
  }
  ...
  insertEmbed (index, embed, value, source = Quill.sources.API, linename) {
    return modify.call(
      this,
      () => {
        return this.editor.insertEmbed(index, embed, value, linename);
      },
      source,
      index
    );
  ...
  insertText (index, text, name, value, source, linename) {
    let formats;
    // eslint-disable-next-line prefer-const
    [index, , formats, source] = overload(index, 0, name, value, source);
    return modify.call(
      this,
      () => {
        return this.editor.insertText(index, text, formats, linename);
      },
      source,
      index,
      text.length
