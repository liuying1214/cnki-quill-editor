...
class ShadowBlot implements Blot {
  ...
  public formatAt(
    ...
    // console.log('P-shadow-formatAt', index, length, name, value)
    const blot = this.isolate(index, length);
  ...
  public insertAt(index: number, value: string, def?: any): void {
    // console.log('P-shadow-insertAt', linename)
    const blot =
      def == null
  ...
  public wrap(name: string | Parent, value?: any): Parent {
    // console.log('P-shadow-wrap', name, value)
    const wrapper =
      typeof name === 'string'
