...
class ParentBlot extends ShadowBlot implements Parent {
  ...
  public appendChild(other: Blot): void {
    // console.log('P-parent-appendChild', other)
  ...
  public insertAt(index: number, value: string, def?: any): void {
    // console.log('P-parent-insertAt', index, value)
    const [child, offset] = this.children.find(index);
    if (child) {
  ...
  public insertBefore(childBlot: Blot, refBlot?: Blot | null): void {
    // console.log('P-parent-insertBefore', childBlot, refBlot)
    ...
    if (
      ...
      // console.log('refDomNode', refDomNode)
      // console.log('childBlot', childBlot.domNode)
